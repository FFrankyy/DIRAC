...
void NStepReplayMem::Add(std::shared_ptr<MaxcutEnv> env,int n_step)
{
...
{
    std::shared_ptr<ReplaySample> result {new ReplaySample()};
//    std::shared_ptr<ReplaySample> result =std::shared_ptr<ReplaySample>(new ReplaySample());
