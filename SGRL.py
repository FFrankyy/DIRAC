...
#################################################New code for graphDQN#####################################
    ...
    def Train(self):
        ...
        #current_gurobi_best, best_iter = 0.0, 0 # record the best result until now
        ...
        for iter in range(args.max_iteration):
            ...
            if iter % 300 == 0:
               ...
               # if iter > 5000 and current_gurobi_best < valid_gurobi:
               #     current_gurobi_best = valid_gurobi
               #     best_iter = iter
                #print ('Current_gurobi_best: %.4f, best_iter:%d'%(current_gurobi_best, best_iter))
