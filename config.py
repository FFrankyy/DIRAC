...
def parsers():
    # Training settings
    parser = argparse.ArgumentParser(description='Hyperparameters for SGRL')
    ## lattice generation
    ...
    parser.add_argument('--test_scale', type=int, default=10, help='max scale of lattice generation')
    parser.add_argument('--scale', type=str, default='2x2x2', help='lattice scales')
    parser.add_argument('--num_run', type=int, default=1, help='lattice scales')
    ...
    parser.add_argument('--numInits', type=int, default=1, help='number of initial states')
    parser.add_argument('--gid', type=int, default=1, help='test graph id')
    parser.add_argument('--method', type=str, default='SA', help='method')
    ## DQN
