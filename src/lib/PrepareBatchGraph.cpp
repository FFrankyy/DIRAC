...
////        temp_feat.push_back(degrees[i]);
////        temp_feat.push_back(node_states[i]);
////        if (node_states[i] == -1)
////        {
...
////        else
////        {
////            temp_feat.push_back((double)node_states[i]);
////        }
//
////        temp_feat.push_back((double)node_states[i]);
...
////            temp_feat.push_back(1.0);
////        }
////      node coordinates feat
//        for (size_t j = 0; j < g->node_coords_dim; ++j)
//        {
//            temp_feat.push_back(g->node_coords[i*g->node_coords_dim+j]);
//        }
//
//        node_feat.push_back(temp_feat);
//    }
    if (actions)
    {
